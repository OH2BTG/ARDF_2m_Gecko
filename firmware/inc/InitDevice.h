...
// $[User-defined pin name abstraction]
	...
	#define BAT_APORT           adcPosSelAPORT3XCH10// PA2 ARDF Battery meter 
//	#define MIC_APORT           adcPosSelAPORT1YCH19 // PF3
//	#define MIC_APORT           adcPosSelAPORT2YCH18 // PF2

	#define PA0_25dB_PIN		(0)  // ARDF OH2BTG 25dB attn
	#define PA0_25dB_PORT		(gpioPortA) // ARDF OH2BTG

	#define ARDF_PA2_PIN		(2)		//ARDF OH2BTG battery meas
	#define ARDF_PA2_PORT		(gpioPortA)	//ARDF OH2BTG 

	#define ARDF_PA5_PIN		(5)		//ARDF OH2BTG 
	#define ARDF_PA5_PORT		(gpioPortA)	//ARDF OH2BTG 
	...
	#define ARDF_F11_PIN		(11)			// ARDF Same as PB11 OH2BTG switch att OFF
	#define ARDF_F11_PORT		(gpioPortB)  

	#define PB12_65dB_PIN		(12)			// ARDF OH2BTG 65dB attn
	#define PB12_65dB_PORT		(gpioPortB)
