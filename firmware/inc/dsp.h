...
// TX sample rate
#define TX_FS 24000
// ARDF Remove the const keyword to allow modification
extern float agc_attack;     // ARDF
extern float global_agc_decay;      // ARDF
extern float global_amp;     // ARDF from dsp to ui display
extern float global_agc_amp; // ARDF from ui to dsp 
extern float global_o_disp; // ARDF
extern float agc_amp; // ARDF
extern int agc_normal; 
