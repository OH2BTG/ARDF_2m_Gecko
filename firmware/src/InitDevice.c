...
extern void USART0_enter_DefaultMode_from_RESET(void) {
	...
	// $[USART_InitAsync]
	USART_Enable(USART0, usartDisable); // ARDF disable USART0 it is using  PA0 and PA1 ports
	...
	USART0->ROUTEPEN = 0;  // ARDF
	USART0->ROUTELOC0 = 0; // ARDF
...
extern void PORTIO_enter_DefaultMode_from_RESET(void) {
	...
	GPIO_PinModeSet(ARDF_F11_PORT, ARDF_F11_PIN, gpioModeInputPull,1); // ARDF Switch att off
	GPIO_PinModeSet(PB12_65dB_PORT, PB12_65dB_PIN, gpioModePushPull, 0); // ARDF 65dB attn
	GPIO_PinModeSet(PA0_25dB_PORT,PA0_25dB_PIN, gpioModePushPull, 0);  // ARDF 25dB attn
	
	//Various pins
	GPIO_PinModeSet(PWM_PORT, PWM_PIN, gpioModePushPull, 0);
	GPIO_PinModeSet(ARDF_PA2_PORT,ARDF_PA2_PIN,gpioModeDisabled, 0);  // ARDF analog in for battery meas
	GPIO_PinModeSet(ARDF_PA5_PORT,ARDF_PA5_PIN,gpioModeInputPull, 1); // ARDF switch
#ifdef RX_EN_PIN
